...
import { SettingsOutlined, Message } from "@mui/icons-material";
import "macro-css";
				...
				<div className="d-flex justify-between">
					<div>
						<Avatar
							...
							src="https://avatarfiles.alphacoders.com/798/79894.jpg"
						/>
						<Typography
					...
					<div>
						<Link href="/profile/settings">
							<Button
								style={{ height: 42, minWidth: 45, marginRight: 10 }}
								variant="contained"
							>
								<SettingsOutlined />
							</Button>
						...
						<Button
							style={{ height: 42, color: "black", background: "#909bea  " }}
							variant="contained"
						>
							<Message className="mr-10" />
							Написать
						</Button>
					</div>
				</div>
